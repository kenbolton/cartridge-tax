...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.total_tax'
        db.add_column('shop_order', 'total_tax',
        ...
        db.add_column('shop_product', 'tic',
                      self.gf('django.db.models.fields.CharField')(default='00000', max_length='5', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.total_tax'
        db.delete_column('shop_order', 'total_tax')
    ...
    models = {
        ...
        'shop.order': {
            ...
            'total_tax': ('cartridge.shop.fields.MoneyField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
        ...
        'shop.product': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
            'tic': ('django.db.models.fields.CharField', [], {'default': "'00000'", 'max_length': "'5'", 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
